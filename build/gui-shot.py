...
with open(os.path.join(T, "ban.json"), "w", encoding="utf-8") as f:
    json.dump({"ts": now.isoformat(), "host": "axle-thu", "pending": [
        ...
        "may_bao": [{"id": "mang-x1", "loai": "mang", "tieu_de": "Máy vừa có mạng lại sau 2 giờ 30 phút",
                     "noi_dung": "Mất từ 07:45 tới 10:15. Lúc đó: Dây có tín hiệu nhưng không router nào cấp IP.", "luc": gio(7200)},
                    {"id": "dia-x2", "loai": "dia", "tieu_de": "Ổ đĩa gần đầy: 91%", "noi_dung": "Còn 21 GB trống. Dọn bớt, hoặc bảo Axle: \"dọn ổ đĩa\".", "luc": gio(90000)}],
